    ...
    def like_photo_by_hashtag(self, hashtag):
        ...
        for url in posts_urls:
            try:
                ...
                count_likes += 1
                print(f"count_likes {count_likes}")
                ...
                with open(f"{file_name}/{file_name}.txt") as text_file:
                    ...
                    for user in users_urls:
                        try:
                            ...
                            browser = self.browser
                            browser.get(user)
                            page_owner = self.xpath_exists("/html/body/div[1]/section/main/div/header/section/div[1]/h2")
...
for user, user_data in users_settings_dict.items():
    ...
    my_bot.login()
    my_bot.like_photo_by_hashtag("Minsk")
    # my_bot.get_all_followers('https://www.instagram.com/divanby_com/')
